...
include_once(drupal_get_path('theme', 'bwet') . '/includes/twitter_bootstrap.inc');
include_once(drupal_get_path('theme', 'bwet') . '/includes/modules/theme.inc');
include_once(drupal_get_path('theme', 'bwet') . '/includes/modules/pager.inc');
include_once(drupal_get_path('theme', 'bwet') . '/includes/modules/form.inc');
include_once(drupal_get_path('theme', 'bwet') . '/includes/modules/admin.inc');
include_once(drupal_get_path('theme', 'bwet') . '/includes/modules/menu.inc');
...
foreach ($modules as $module) {
  if (is_file(drupal_get_path('theme', 'bwet') . '/includes/modules/' . str_replace('_', '-', $module) . '.inc')) {
    include_once(drupal_get_path('theme', 'bwet') . '/includes/modules/' . str_replace('_', '-', $module) . '.inc');
  }    
}
